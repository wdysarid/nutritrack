                ...
                <div class="sidebar-item recent-posts">
                    ...
                    <div class="row">
                        ...
                        <div class="post-item" style="width: 100%; display: flex; margin-bottom: 50px;">
                                <img src="<?= base_url('assets1/img/blog/sayur.jpg') ?>" alt="" class="flex-shrink-0" style="width: 20%; object-fit: cover;">
                                <div style="flex: 1; padding-left: 15px;">
                                    <h4><a href="<?= base_url('clandingpg/blog') ?>">Manfaat Makan Sayur Untuk Kesehatan Tubuh</a></h4>
                                    <time datetime="2024-01-01">Januari 6, 2023</time>
                                </div>
                            </div><!-- End recent post item-->

                            <div class="post-item" style="width: 100%; display: flex; margin-bottom: 50px;">
                                <img src="<?= base_url('assets1/img/blog/alergy.jpg') ?>" alt="" class="flex-shrink-0" style="width: 20%; object-fit: cover;">
                                <div style="flex: 1; padding-left: 15px;">
                            ...
                            <div class="post-item" style="width: 100%; display: flex; margin-bottom: 50px;">
                                <img src="<?= base_url('assets1/img/blog/drinkice.jpg') ?>" alt="" class="flex-shrink-0" style="width: 20%; object-fit: cover;">
                                <div style="flex: 1; padding-left: 15px;">
                        ...
                        <!-- kolom kanan -->
                                <div class="post-item" style="width: 100%; display: flex; margin-bottom: 50px;">
                                <img src="<?= base_url('assets1/img/blog/makanansehat.jpg') ?>" alt="" class="flex-shrink-0" style="width: 20%; object-fit: cover;">
                                <div style="flex: 1; padding-left: 15px;">
                                    <h4><a href="<?= base_url('clandingpg/blog') ?>">Manfaat Menkonsumsi Makanan Sehat</a></h4>
                                    <time datetime="2024-01-01">Jan 9, 2024</time>
                                </div>
                            </div><!-- End recent post item-->

                                 <div class="post-item" style="width: 100%; display: flex; margin-bottom: 50px;">
                                <img src="<?= base_url('assets1/img/blog/polasehat.jpg') ?>" alt="" class="flex-shrink-0" style="width: 20%; object-fit: cover;">
                                <div style="flex: 1; padding-left: 15px;">
                            ...
                            <div class="post-item" style="width: 100%; display: flex; margin-bottom: 50px;">
                                <img src="<?= base_url('assets1/img/blog/kalsium.jpg') ?>" alt="" class="flex-shrink-0" style="width: 20%; object-fit: cover;">
                                <div style="flex: 1; padding-left: 15px;">
                                    <h4><a href="<?= base_url('clandingpg/blog5') ?>">Apa Itu Kalsium Dan Apa Manfaatnya Untuk Tubuh</a></h4>
                                    <time datetime="2024-01-01">Juni 4, 2023</time>
                                </div>
                            </div><!-- End recent post item-->
