			...
			<div class="row g-5">
				...
				<div class="col-lg-10">
					...
					<article class="article">
						...
						<div class="meta-top">
							<ul>
								<li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="<?=base_url('')?>">Admin</a>
								</li>
							...
							<div class="sidebar-item recent-posts">
								...
								<div class="post-item">
									...
									<div>
										...
										<time datetime="2022-01-07">Juni 8, 2022</time>
									</div>
								</div><!-- End recent post item-->
								...
								<div class="post-item">
									...
									<div>
										...
										<time datetime="2022-01-07">20 November, 2023</time>
									</div>
								</div><!-- End recent post item-->
								...
								<div class="post-item">
									...
									<div>
										<h4><a href="<?=base_url('clandingpg/blog6')?>">Apa Itu Kalsium Dan Apa Manfaatnya Untuk Tubuh</a>
										</h4>
										<time datetime="2022-01-07">Juni 5, 2023</time>
									</div>
								</div><!-- End recent post item-->
