...
<style>
    header h1 {
        font-size: 24px;
        /* Sesuaikan ukuran font dalam piksel sesuai keinginan Anda */
        margin-bottom: 5px;
...
=======
                    <h5 class="card-title" style="font-size: 20px; font-weight: bold;">Manfaat Menkonsumsi Makanan Sehat
                    </h5>
                    <p class="card-text">Konsumsi makanan sehat tiap harinya sangat diperlukan tubuh untuk memenuhi
                        asupan nutrisi tubuh. Lalu, apakah yang dimaksud dengan makanan sehat?</p>
>>>>>>> 641e5f51c029f18b75dc7da3eb26a6004a16b420
        ...
        <div class="col-md-4">
            <div class="card mb-3" style="background-color: #a8debd">
                ...
                <div class="card-body">
                    <h5 class="card-title" style="font-size: 20px; font-weight: bold;">Tips Menjaga Pola Hidup Sehat
                    </h5>
                    <p class="card-text">Pola hidup sehat merupakan suatu kebutuhan yang tidak dapat ditinggalkan oleh
                        seluruh orang. Serta pola hidup ini menjadi tren pada masa sekarang ini. Hal ini dikarenakan
                        pada jaman ini semakin banyak timbul penyakit – penyakit baru.</p>
        ...
        <div class="col-md-4">
            <div class="card mb-3" style="background-color: #a8debd">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Alergi makanan adalah kondisi saat sistem kekebalan tubuh secara keliru
                        menganggap suatu zat seperti protein dalam makanan tertentu berbahaya bagi tubuh. Akibatnya,
                        sistem kekebalan tubuh akan bereaksi terhadap zat makanan yang tergolong berbahaya tersebut.</p>
...
<div class="card-container" id="about">
    <div class="custom-card" style="background-color: #DDFFBB">
        ...
        <p>
            ...
            makanan yang dikonsumsi perhari dan jumlahnya serta mencatat aktivitas pengguna perhari seperti nama
            aktivitas, mulai aktivitas, lama aktivitas, dan selesai aktivitas.</p>
    </div>
</div>
<!-- Akhir About -->
...
<body>
    ...
    <div class="card-container" id="benefit">
        <div class="card">
            ...
            <p>Dapat mencatatat makanan yang anda konsumsi perhari, seperti nama makanan, dan berapa jumlah konsumsi
                makanan tersebut.</p>
        </div>

        <div class="card">
            <h2>Dapat Melihat Artikel Kesehatan</h2>
            <p>Anda dapat melihat artikel sesuai dengan yang anda catat sebelumnya ataupun artikel yang terkait dengan
                kesehatan.</p>
        </div>

        <div class="card">
            <h2>Dapat Melakukan Pencatatan Aktivitas</h2>
            <p>Anda dapat mencatat aktivitas yang anda lakukan perhari seperti nama aktivitas, jam mulai, jam selesai
                dan lama aktivitas yang anda lakukan.</p>
        </div>
    </div>
    <!-- Akhir benefits -->
