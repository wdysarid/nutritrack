						...
						<div class="card">
							...
							<div class="card-body">
								...
								<button type="button" class="btn btn-warning mb-3"
									onclick="cetaknutrisihr(<?= $this->session->userdata('id_member');?>)">Cetak Data
									Harian</button>
								...
								?>
											<tr>
												...
												<td><?php echo number_format($row['total_kalori'], 0, '.', '')?> kkal
												</td>
			...
			<div class="card recent-sales overflow-auto">
				...
				<div class="card-body">
					...
					<div class="card">
						...
						<div class="card-body">
							<a class="btn btn-primary mb-3" href="<?php echo base_url('cmember/catataktivitas') ?>">Form
								Catat Nutrisi</a>
							<button type="button" class="btn btn-warning mb-3"
