		...
		<div class="row">
					...
					<div class="col-12">
						<div class="card recent-sales overflow-auto">
							...
							<div class="card-body">
							<a class="btn btn-primary mb-3"  href="<?php echo base_url('cmember/catataktivitas') ?>">Form Catat Nutrisi</a>
							<button type="button" class="btn btn-warning mb-3" onclick="cetakaktivitashr(<?= $this->session->userdata('id_member');?>)" >Cetak Data Harian</button>
							<div class="" style="overflow: scroll;">
							<table class="table display" id="myTable" >
							<thead>
								<tr>
